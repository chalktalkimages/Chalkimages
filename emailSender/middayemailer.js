...
function aggregateBlockList() {
  ...
  port = '9001';
      ...
      performRequest('/block-list', 'POST', blockquery, function(series) {
          ...
          console.log('Sending create midday block report and email request to chalk ...\n')
          port = '9002';
          performRequest('/send-morning-BlockReport', 'POST', {fullname: 'AllBlockReportEmail', blocks: blockList, isFlow: true}, function() {
