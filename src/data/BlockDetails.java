...
public class BlockDetails {
		...
		public BlockDetails(String brokerName, Double notional, Integer tradeSize, String ticker, String brokerID, Double tradePrice, Long tradeTime, String trader, String analyst) {
		...
		public boolean equals(Object obj) {
			...
			if (tradePrice == null) {
				...
				return false;
			if (tradeSize == null) {
				if (other.tradeSize != null)
					return false;
			} else if (!tradeSize.equals(other.tradeSize))
				return false;
			if (tradeTime == null) {
