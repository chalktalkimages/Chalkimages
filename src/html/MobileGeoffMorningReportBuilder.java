...
public class MobileGeoffMorningReportBuilder {
  ...
  public static void buildReport(
    ...
    String body = Utilities.getHTMLString("MobileGeoffMorningReportTemplate.html");
  ...
  public static String getNotableNews(
    ...
    String result = "";
    String temp = "";
    String sectorSymbolComment = Utilities.getHTMLString("MobileGeoffSectorSymbolComments.html");
    ...
    for (String sector : sectors) {
      ...
      String symbolComments = getSymbolComments(currComments, includeDetailedComment);
  ...
  public static String getMorningIndications(String buy, String sell) {
    String morningIndications = Utilities.getHTMLString("MobileGeoffMorningIndications.html");
    morningIndications =
