...
public final class SymbolConverter {
	...
	private static String[] SYMBOL_SUFFIX = { ".TSXV", ".TSX", ".NYS", ".NAS",
			"ARC", ".PF", ".UN", ".DB", ".WT", ".PR", ".RT" };
	private static String[] REUTERS_SUFFIX = { ".V", ".TO", ".N", ".O", ".P",
			"_pf", "_u", "db", "_t", "_p", "_r" };
	...
	public static String RIC2Symbol(String ric) {
		...
		for (int i = 0; i < REUTERS_SUFFIX.length; i++) {
			if (REUTERS_SUFFIX[i].equals("_pf") && ric.contains("_pf."))
				continue;
